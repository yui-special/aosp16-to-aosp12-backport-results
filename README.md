...
> 导致编译不过、语义完全反向），而三次都自报 "Successfully"。
> [`CVE-2026-0045/2-PortGPT-generated.patch`](./CVE-2026-0045) 收录的正是可用那一次；
> 同目录的 `1-AOSP16-fix-mapped.patch` 是把官方修复的路径映射到 A12 布局之后的版本。
